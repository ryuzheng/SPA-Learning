...
spa.chat = (function() {
  ...
  setPxSizes = function() {
    ...
    opened_height_em = window_height_min_em > configMap.window_height_min_em ? configMap.slider_opened_em : configMap.slider_opened_min_em;
  ...
  //    * callback - optional callback to be run end at the end of slider animation. The callback receives a jQuery collection representing the slider div as its single Argument
  //  Action:
  //  This method moves the slider into the requested position. If the requested position is the current position, it returns true without taking further action
  //  Returns:
  ...
  //  Purpose: Configure the module prior to initializes
  //  Arguments:
  ...
  //    * chat_model - the chat model object provides methods to interact with our model instant messaging
  //    * people_model - the people model object which provides methods to manage the list of people model object which provides methods to manage the list of people the model maintains
  ...
  //  Action:
  //    Appends the chat slider to the provided container and fills it with HTML content. It then initializes elements, events, and handlers to provide the user with a chat-room interface
  ...
  removeSlider = function() {
    ...
    config_map.set_chat_anchor = null;
  ...
  handleResize = function() {
    // dont't do anything if we don't have a slider container
    if (!jqueryMap.$slider) {
      return false;
    }
    setPxSizes();
